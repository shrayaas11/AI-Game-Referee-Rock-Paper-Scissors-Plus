...
validate_move:Validates player input and enforces the one-time bomb usage rule.

resolve_round:Applies game logic and determines the winner of each round.

update_game_state:Updates persistent state including round count, bomb usage, and game termination.
